...
INSERT INTO `category` VALUES (1,'Мужские'),(2,'Женские'),(3,'Унисекс');
...
INSERT INTO `manufacturer` VALUES (1,'Chanel','Франция'),(2,'Dior','Франция'),(3,'Hermès','ryrrthrh'),(4,'Maison Francis Kurkdjian','Франция'),(5,'Tom Ford','США'),(6,'Byredo','Франция'),(7,'Givenchy','Франция'),(8,'Zielinski & Rozen','Польша'),(10,'Faberlic','Россия'),(11,'Lacoste','Франция'),(12,'Dolce & Gabbana','Италия'),(13,'FM by Federico Mahora','Германия'),(14,'Jo Malone','Великобритания'),(15,'Gucci','Италия'),(16,'Yodeyma','Испания'),(17,'Yves Rocher','Франция'),(18,'Giorgio Armani','Италия'),(19,'S Parfum','Россия'),(20,'Guerlain','Франция'),(21,'Clive Christian','Великобритания'),(22,'Sergio Tacchini','Италия'),(23,'Escentric Molecules','Германия'),(24,'Mancera','Франция'),(25,'Dzintars','Латвия'),(26,'Antonio Banderas','Испания'),(27,'Brioni','Италия'),(28,'Amouage','Оман'),(29,'Omerta','Италия'),(30,'Kenzo','Франция'),(31,'Новая Заря','Россия'),(32,'Versace','Италия'),(33,'Brocard','Россия'),(34,'Bershka','Испания'),(35,'Kilian Paris','Франция'),(36,'Burberry','Великобритания'),(37,'Lancôme','Франция'),(38,'Hugo Boss','Германия'),(39,'Bvlgari','Италия'),(40,'Северное Сияние','Россия'),(41,'Amway','США'),(42,'Yves Saint Laurent','Франция'),(43,'Vince Camuto','США'),(44,'Trussardi','Италия'),(45,'Lalique','Франция'),(46,'Pull & Bear','Испания'),(47,'Moschino','Италия'),(48,'Tiziana Terenzi','Италия'),(49,'Victoria\'s Secret','США'),(50,'Chloé','Франция');
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`OrderUser`) REFERENCES `User` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`OrderStatus`) REFERENCES `Status` (`StatusID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `product` (
  ...
  CONSTRAINT `ProductManufacture` FOREIGN KEY (`ProductManufacture`) REFERENCES `manufacturer` (`ManufacturerID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Quantity` FOREIGN KEY (`ProductCategory`) REFERENCES `category` (`CategoryID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product` VALUES ('A00001','Chanel No.5 Eau de Parfum',9000,10,1,2,50,'Люксовый женский аромат от Chanel','50ml','chanel_no5.jpg'),('A00002','Dior Sauvage Eau de Toilette',6000,15,2,1,40,'Мужской аромат от Dior, нишевый','100ml','dior_sauvage.jpg'),('A00003','Hermès Terre d\'Hermès',7125,5,3,1,30,'Люксовый мужской аромат от Hermès','100ml','hermes_terre.jpg'),('A00004','Avon Little Black Dress',1875,20,4,2,100,'Доступный женский аромат, массовый','30ml','avon_lbd.jpg'),('A00005','Tom Ford Black Orchid',11250,10,5,2,20,'Люксовый нишевый женский аромат от Tom Ford','50ml','tomford_blackorchid.jpg'),('A00006','Oriflame Eclat Femme',2250,10,6,2,70,'Массовый женский аромат','50ml','non.jpg'),('A00007','Givenchy Ange ou Démon',8250,12,7,2,25,'Люксовый женский аромат','50ml','givenchy_ange.jpg'),('A00008','Zielinski & Rozen Amber',3375,8,8,3,60,'Унисекс нишевый аромат','30ml','zielinski_amber.jpg'),('A00010','Faberlic Exotic',1500,25,10,3,200,'Массовый унисекс аромат','50ml','non.jpg'),('A00011','Lacoste Blanc',5250,10,11,1,80,'Мужской массовый аромат','100ml','lacoste_blanc.jpg'),('A00012','Dolce & Gabbana Light Blue',6375,10,12,2,90,'Женский популярный аромат','100ml','dg_lightblue.jpg'),('A00013','FM Federico Mahora 471',2625,15,13,3,50,'Унисекс нишевый аромат','50ml','faberico471.jpg'),('A00014','Jo Malone Peony & Blush Suede',9375,10,14,2,40,'Люксовый женский аромат','30ml','jomalone_peony.jpg'),('A00015','Gucci Guilty Pour Homme',7125,10,15,1,35,'Люксовый мужской аромат','90ml','gucci_guilty.jpg'),('A00016','Yodeyma Vanilla',3000,12,16,3,100,'Массовый унисекс с ванилью','50ml','yodeyma_vanilla.jpg'),('A00017','Yves Rocher Petitgrain',2250,20,17,1,60,'Массовый мужской аромат','100ml','non.jpg'),('A00018','Giorgio Armani Si',8625,10,18,2,45,'Люксовый женский аромат','50ml','armani_si.jpg'),('A00019','S Parfum Musk',1875,15,19,3,80,'Массовый унисекс парфюм','50ml','non.jpg'),('A00020','Guerlain Shalimar',10500,8,20,2,20,'Люксовый женский аромат','50ml','guerlain_shalimar.jpg'),('A00021','Clive Christian X',18750,5,21,1,10,'Люксовый мужской парфюм','50ml','clive_x.jpg'),('A00022','Sergio Tacchini Sport',3375,10,22,1,55,'Массовый мужской спорт аромат','100ml','non.jpg'),('A00023','Escentric Molecules Molecule 01',9000,10,23,3,25,'Нишевый унисекс','100ml','escentric_molecule.jpg'),('A00024','Mancera Cedrat Boise',9750,7,24,3,15,'Нишевый унисекс','120ml','mancera_cedrat.jpg'),('A00025','Dzintars Amber',1875,20,25,2,80,'Массовый женский аромат','30ml','non.jpg'),('A00026','Antonio Banderas Blue Seduction',2625,15,26,1,70,'Массовый мужской аромат','100ml','antonio_banderas_blue.jpg'),('A00027','Brioni Uomo',11250,10,27,1,20,'Люксовый мужской парфюм','100ml','brioni_uomo.jpg'),('A00028','Amouage Reflection',13500,12,28,2,12,'Люксовый женский аромат','100ml','amouage_reflection.jpg'),('A00029','Omerta Noir',5250,10,29,1,40,'Массовый мужской аромат','100ml','omerta_noir.jpg'),('A00030','Kenzo Jungle',6375,8,30,2,35,'Женский нишевый аромат','100ml','kenzo_jungle.jpg'),('A00031','Новая Заря Classic',2250,20,31,2,150,'Массовый женский аромат','50ml','non.jpg'),('A00032','Versace Eros',7125,10,32,1,45,'Люксовый мужской аромат','100ml','versace_eros.jpg'),('A00033','Brocard Classic',1500,25,33,3,200,'Унисекс нишевый','50ml','brocard_classic.jpg'),('A00034','Bershka Fresh',1125,30,34,3,300,'Массовый унисекс','30ml','bershka_fresh.jpg'),('A00035','Kilian Black Phantom',21000,5,35,2,10,'Люксовый нишевый','50ml','kilian_blackphantom.jpg'),('A00036','Burberry Brit',6000,10,36,2,60,'Массовый женский аромат','100ml','burberry_brit.jpg'),('A00037','Lancôme La Vie Est Belle',6750,10,37,2,80,'Люксовый женский аромат','50ml','lancome_belle.jpg'),('A00038','Hugo Boss Bottled',5625,10,38,1,65,'Массовый мужской аромат','100ml','hugo_boss_bottled.jpg'),('A00039','Bvlgari Man in Black',9000,8,39,1,25,'Люксовый мужской','100ml','bvlgari_man.jpg'),('A00040','Северное Сияние Arctic',2625,15,40,3,90,'Унисекс нишевый','50ml','non.jpg'),('A00041','Amway Artistry',3750,10,41,2,55,'Массовый женский','50ml','non.jpg'),('A00042','Yves Saint Laurent Black Opium',8250,10,42,2,40,'Люксовый женский','50ml','ysl_blackopium.jpg'),('A00043','Vince Camuto Fierce',6375,10,43,1,50,'Массовый мужской','100ml','vince_fierce.jpg'),('A00044','Trussardi My Name',5250,10,44,2,45,'Массовый женский','50ml','trussardi_myname.jpg'),('A00045','Lalique Encre Noire',7125,8,45,1,30,'Люксовый мужской','100ml','lalique_encrenoire.jpg'),('A00046','Pull & Bear Fresh',900,20,46,3,150,'Массовый унисекс','30ml','non.jpg'),('A00047','Moschino Toy Boy',7500,10,47,1,25,'Массовый мужской','50ml','moschino_toyboy.jpg'),('A00048','Tiziana Terenzi Orion',22500,5,48,3,8,'Нишевый унисекс','100ml','tiziana_orion.jpg'),('A00049','Victoria\'s Secret Bombshell',3375,15,49,2,70,'Массовый женский','50ml','victoria_bombshell.jpg'),('A00050','Chloé Eau de Parfum',9375,10,50,2,35,'Люксовый женский','50ml','chloe_eau.jpg'),('A56785','dgnfg dfgh fh',56768,56,29,3,35,'sdgdsfgdsg','100ml',NULL);
...
CREATE TABLE `supplies` (
  ...
  CONSTRAINT `ProductArticle` FOREIGN KEY (`ProductArticle`) REFERENCES `product` (`ProductArticleNumber`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `SupplierID` FOREIGN KEY (`SupplierID`) REFERENCES `suppliers` (`SuppliersID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-11-14 18:00:32
